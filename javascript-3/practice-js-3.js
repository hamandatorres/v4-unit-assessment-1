...
function checkGroceryCount () {
    groceries.length
    if (i = 0, groceries.length > 5, i++) {
        return 'That looks like a big trip'
    }
    else if (i = 0, groceries.length === 1, i++) {
        return '1 item'
    }
    else (i = 0, groceries.length <== 1 && groceries.length ==> 5, i++) {
        return '$() items'
    }
    }
